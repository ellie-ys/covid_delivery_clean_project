...
const Issue = () => {
  ...
  return (
    <>
      <TitleStyle>
        <h1>[속보] 코로나 이후 배달 위생상태 민원 31.6% 最大... 충격!</h1>
      </TitleStyle>

      <TextStyle>
        최근, 외식 대신 배달음식 서비스 이용자가 늘어나면서&nbsp;
        <ClickGraph onClick={() => setIsOpen1(true)}>배달 대행 건수</ClickGraph>
        가 급격하게 증가하였습니다.
        <Modal
          isOpen={modalIsOpen1}
      ...
      <TextStyle>
        그와 함께&nbsp;
        <ClickGraph onClick={() => setIsOpen2(true)}>배달음식 민원</ClickGraph>
      ...
      <TextStyle>
        2020년 한 해 동안,
        <ClickGraph onClick={() => setIsOpen4(true)}>식품 적발건수</ClickGraph>
      ...
      <TextStyle>
        <span style={{ fontWeight: "bold" }}>클린한끼</span>에서 많은 소비자들이
        위생에 대한 정보를 정확하게 알 수 있도록,
      </TextStyle>
